...
assert imgurParser("http://imgur.com/a/cjh4E") == {"id": "cjh4E", "type": "album"}
assert imgurParser("http://imgur.com/gallery/59np6") == {
    "id": "59np6",
    "type": "gallery",
}
assert imgurParser("http://imgur.com/0zZUNMM") == {"id": "0zZUNMM", "type": "image"}
assert imgurParser("http://i.imgur.com/altd8Ld.png") == {
    "id": "altd8Ld",
    "type": "image",
}
