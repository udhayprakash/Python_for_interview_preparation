...
class Solution:
    def intToRoman(self, num):
        ...
        for each_num in integer_to_roman_mapping:
            ...
            if divisor:
                roman_number += divisor * integer_to_roman_mapping[each_num]
                num = remainder
        return roman_number
...
s = Solution()
assert s.intToRoman(482) == "CDLXXXII"
assert s.intToRoman2(482) == "CDLXXXII"
...
for int, romainStr in roman_nums.items():
    assert s.intToRoman(int) == romainStr
    assert s.intToRoman2(int) == romainStr
